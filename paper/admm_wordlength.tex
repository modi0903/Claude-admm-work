...
\toprule
work & device / format & problem & LUT & MHz & power (method) \\
\midrule
This work (baseline) & Artix-7 35T, 18 b (Q2.16) & N=8 & 4673 & 66.3 & 11\,mW (SAIF, routed) \\
\textbf{This work} & Artix-7 35T, 11 b (Q2.9) & N=8 & 2574 & 85.4 & 7\,mW (SAIF, routed) \\
\midrule
Jerez 2014 & Virtex-6, 18 fb & 216 var & n/r & 400 & n/r (---) \\
ADMIN 2021 & V7 690T, 18 b & 16x16 det. & 13392 & 263 & n/r (---) \\
TASER 2016 & V7 690T, 14 b & N=9 det. & 4790 & 232 & 600\,mW (tool est.) $\dagger$ \\
Wu 2022 & ZCU106, mixed 20-$>$24 b & n=16 patch & 6807 & 403 & 307\,mW (XPE) \\
Hamadouche 2023 & ZCU106 HLS, 24 b & LASSO, 5 it. & 1822 & 157 & 44\,mW (post-impl. est.) \\
RSQP 2023 & Alveo U50, fp32 & $10^1$--$10^5$ var & 24245 & 300 & 19\,W (board meas.) \\
Zhang 2025 & ZCU102, ap\_fixed 24/9 & 1619 var & 147238 & 250 & 10.7\,W (unstated) \\
AccelMPC 2026 & Artix-7 100T, 32 b & H=40, k=10 & n/r & 100 & n/r (post-route est.) \\
Peccin 2020 & MAX10 (DE10-Lite), 16 b (10 frac) & Nu=5 GPC & n/r & 50 & n/r (---) \\
\bottomrule
\end{tabular}
\\[2pt]\footnotesize $\dagger$ forward--backward splitting, not ADMM.
\end{center}
...
\paragraph{Fairness decisions, stated rather than hidden.} TASER is
forward--backward splitting, not ADMM, and is marked with a dagger; it is kept
because it is the same group, part and fixed-point discipline as ADMIN.
Peccin et al.\ report Intel logic elements (30\,662 LE, 62\% of a MAX10), which
are not Xilinx Slice LUTs, so their area cell is left empty rather than
converted --- but their number format is the most directly comparable choice in
the table: 16 bits with 10 fractional bits, stated without derivation, on a
low-cost board, which is exactly the decision this paper's model replaces.
AccelMPC reports utilisation only as percentages and gives no absolute power;
dividing its published energy by its published latency would imply a few
hundred milliwatts, but that quantity is ours, not theirs, so it is recorded in
the data file and not in this table. Escarate et al.\ (ICA-ACCA 2022) implement
ADMM on a ZCU104 through Vitis HLS and report execution times only
(0.365--1.567\,ms for 1--50 iterations), calling their own figures a reference
floor at default settings; with no resources, no power and no stated number
format, the row would be empty and they are cited here instead.
